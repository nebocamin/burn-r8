    ...
    series: [
      {
        ...
        data: [63,67,65,61,57,60,58,52,54,52,49,49,50,50,50,48,45,45,43,39,36,36,36,40,39,43]
      }, {
        name: 'Pending',
        ...
        data: [63,53,53,53,54,55,50,48,48,48,44,43,46,45,45,41,35,35,35,30,30,30,30,36,33,39]
      }, {
        name: 'High & Critical',
        ...
        data: [20,19,17,17,16,16,14,13,13,12,9,9,10,10,10,9,6,6,5,5,5,5,5,8,8,9]
      }, {
        name: 'Normal',
        ...
        data: [25,25,23,23,22,24,22,17,19,20,20,20,20,20,20,20,18,18,17,14,11,11,11,14,13,15]
      }
    ]
  });
});
